...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Stator Limit (Protects Motor/Limits Acceleration)
                .withStatorCurrentLimit(Amps.of(frc.robot.Constants.ModuleConstants.kDrivingMotorCurrentLimit))
                .withStatorCurrentLimitEnable(true)
                // Supply Limit (Prevents Brownout)
                .withSupplyCurrentLimit(frc.robot.Constants.ModuleConstants.kDrivingMotorCurrentLimit)
                .withSupplyCurrentLimitEnable(true)
        );
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Swerve azimuth does not require much torque output, so we set a lower
                // stator current limit and reference the Constants entry for maintainability.
                // Stator Limit (Protects Motor/Limits Acceleration)
                .withStatorCurrentLimit(Amps.of(frc.robot.Constants.ModuleConstants.kSteerMotorCurrentLimit))
                .withStatorCurrentLimitEnable(true)
                // Supply Limit (Prevents Brownout)
                .withSupplyCurrentLimit(frc.robot.Constants.ModuleConstants.kSteerMotorCurrentLimit)
                .withSupplyCurrentLimitEnable(true)
        );
    ...
    public static final TalonFXConfiguration kShooterInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Stator Limit (protect motor / limit acceleration)
                .withStatorCurrentLimit(Amps.of(frc.robot.Constants.ModuleConstants.kShooterMotorCurrentLimit))
                .withStatorCurrentLimitEnable(true)
                // Supply Limit (prevent brownout)
                .withSupplyCurrentLimit(frc.robot.Constants.ModuleConstants.kShooterMotorCurrentLimit)
                .withSupplyCurrentLimitEnable(true)
        );
